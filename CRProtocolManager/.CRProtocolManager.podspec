...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/fvcku/CRProtocolManager"
 ...
 # s.license      = "MIT (example)"
  ...
  s.author             = { "fvcku" => "imissingu@aliyun.com" }
  ...
  s.source       = { :git => "https://github.com/fvcku/CRProtocolManager.git", :tag => s.version }
